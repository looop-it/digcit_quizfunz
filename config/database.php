    ...
    */
    ...
    'connections' => [
        ...
        'membership' => [
            ...
            'unix_socket' => env('MEMBERSHIP_DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'strict' => true,
    ...
    */
    ...
    'redis' => [
        ...
        'paper' => [
            ...
            'password' => env('REDIS_PASSWORD', null),
            'port' => env('REDIS_PORT', 6379),
            'database' => env('REDIS_DATABASE_PAPER', 4),
        ],
        ...
        'user_stats' => [
            ...
            'password' => env('REDIS_PASSWORD', null),
            'port' => env('REDIS_PORT', 6379),
            'database' => env('REDIS_DATABASE_USER_STAT', 5),
        ],
        ...
        'queue' => [
            ...
            'password' => env('REDIS_PASSWORD', null),
            'port' => env('REDIS_PORT', 6379),
            'database' => env('REDIS_DATABASE_QUEUE', 6),
        ],
        ...
        'horizon' => [
            ...
            'password' => env('REDIS_PASSWORD', null),
            'port' => env('REDIS_PORT', 6379),
            'database' => env('REDIS_DATABASE_HORIZON', 7),
        ],
    ]
];
