...
use App\Admin\Widgets\launchBox;
...
class HomeController extends Controller
{
    ...
    public function index()
    {
        return Admin::content(function (Content $content) {
            ...
            // Dashboard charts
            $content->row(function ($row) {
                $row->column(12, new Box('挑戰情況統計', $this->challengeCountChart()->render()));
                $row->column(6, new Box('比賽情況統計', $this->papersDaliyCountChart()->render()));
                $row->column(6, new Box('問卷狀態統計', $this->papersStatusCountChart()->render()));
