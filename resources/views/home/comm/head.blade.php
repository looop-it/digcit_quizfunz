            ...
            <div class="nav-btn visible-xs fexd">
                <div class="navbar-header">
                    ...
                    <div class="logos">
                        ...
                        @guest
                        <div>
                            <a href="{{ route('register') }}"><img src="/home/img/student-up.png" class="logo"/></a>
                        </div>
                        @endguest
                        {{-- 用戶已登入 --}}
                        @auth
        ...
        <div class="col-md-12 col-sm-12">
            <div class="nav nav-header">
                <ul class="clearfix">
                    ...
                    <li>
                        <a href="{{ route('information') }}" class="@if($nav==2)active @endif">{{trans('home.main_menu.game_intro')}}</a>
                        <div class="line"></div>
                    </li>
                    <li>
                        <a href="{{ route('references') }}" class="@if($nav==3)active @endif">{{trans('home.main_menu.ref_info')}}</a>
                        <div class="line"></div>
                    </li>
                    @guest
                        <li>
                    ...
                    @if($global->rank_status==1)
                        <li>
                            <a href="{{ route('ranking') }}" class="@if($nav==5)active @endif">{{trans('home.main_menu.ranking')}}</a>
                        </li>
                    @endif
                    @guest
                        <div class="">
